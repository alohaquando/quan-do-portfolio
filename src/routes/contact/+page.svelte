<script>
	...
	let contactLinks = [
		...
		{ href: 'https://linkedin.com/in/quanhoangdo', icon: 'linkedin', title: 'LinkedIn', subtitle: '/quanhoangdo', colorStyle: 'bg-blue-400 dark:bg-blue-600', ringStyle: 'group-hover:ring-blue-400 dark:group-hover:ring-blue-600' }
	];
</script>
