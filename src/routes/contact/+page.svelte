<script>
	...
	let contactLinks = [
		...
		{ href: 'github.com/alohaquando', icon: 'github', title: 'GitHub', subtitle: '@alohaquando', colorStyle: 'bg-violet-400 dark:bg-violet-600', ringStyle: 'group-hover:ring-violet-400 dark:group-hover:ring-violet-600' },
		{ href: 'linkedin.com/in/quanhoangdo', icon: 'linkedin', title: 'LinkedIn', subtitle: '/quanhoangdo', colorStyle: 'bg-blue-400 dark:bg-blue-600', ringStyle: 'group-hover:ring-blue-400 dark:group-hover:ring-blue-600' }
	];
</script>
