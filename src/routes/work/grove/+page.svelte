<script>
	...
	const data = {
		title: 'GroveHR',
		subtitle: 'HR app with 10k+ downloads, for employees and managers to keep track of time off requests, performance reviews, company news...',
		color: 'green'
	};
</script>
...
<ReaderPage {...data}>
	<IMG_Hero
		eager
		slot="hero_img"
		class="h-12 h-full max-h-[32rem] w-auto" />
