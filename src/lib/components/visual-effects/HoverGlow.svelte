...
<div
	...
	aria-hidden="true"
	class="{colorfulGradients.hover} {className} backdrop-saturate-125 absolute bottom-0 left-0 right-0 top-0 z-0 select-none opacity-0 ring-1 ring-inset ring-white/80 transition-all duration-300 [mask-image:radial-gradient(180px_at_var(--pointerX)_var(--pointerY),white,transparent)] hover:opacity-30"
