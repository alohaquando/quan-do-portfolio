<script>
        ...
        // Image
        import avifSrc
          from "$lib/assets/images/bg/device-concept.avif?width=640;1024;1920&format=avif&srcset";
        import webpSrc
          from "$lib/assets/images/bg/device-concept.avif?width=640;1024;1920&format=webp&srcset";
