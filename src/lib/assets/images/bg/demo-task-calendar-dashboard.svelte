<script>
        ...
        // Image
        import avifSrc
          from "$lib/assets/images/bg/demo-task-calendar-dashboard.avif?width=640&format=avif&quality=95&srcset";
        import webpSrc
          from "$lib/assets/images/bg/demo-task-calendar-dashboard.avif?width=640&format=webp&quality=95&srcset";
